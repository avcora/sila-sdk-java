...
public class CheckKYCTests {
    ...
    public void Response200() throws Exception {
        ...
        response = api.checkKYC(DefaultConfigurations.getUser2Handle(), null, DefaultConfigurations.getUser2PrivateKey());
        ...
        response = api.checkKYC(DefaultConfigurations.getBusinessHandle(), null,
    ...
    public void Response200Failure() throws Exception {
        ...
        ApiResponse response = api.checkKYC(userHandle2Failure, null, userPrivateKeyFailure);
        assertEquals(200, response.getStatusCode());
    ...
    public void Response400() throws BadRequestException, InvalidSignatureException, ServerSideException, IOException,
        ...
        ApiResponse response = api.checkKYC("", null, DefaultConfigurations.getUserPrivateKey());
